...
public final class IKTokenizer extends Tokenizer {
	...
	public boolean incrementToken() throws IOException {
		System.out.println(">>> IKTokenizer, incrementToken()");
		// 清除所有的词元属性
		clearAttributes();
		skippedPositions = 0;
		...
		if (nextLexeme != null) {
			System.out.println("incrementToken() nextLexeme: " + nextLexeme.getLexemeText());
	...
	public void reset() throws IOException {
		System.out.println("--- IKTokenizer, reset()");
		super.reset();
	...
	public final void end() throws IOException {
		System.out.println("--- IKTokenizer, end()");
		super.end();
		// set final offset
